        ...
        <div className="relative z-10 max-w-md mt-12">
          ...
          >
            ...
            <p className="text-foreground-muted text-sm leading-relaxed mb-8">
              Experience the adrenaline of real-time, high-stakes auction drafts. Manage your $100M salary cap, deploy
              AI-driven insights, and outbid your friends with sub-millisecond latency.
            </p>
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white uppercase tracking-wider mb-0.5">
                    Ultra-Low Latency Bids
                  </h4>
                  <p className="text-[11px] text-foreground-muted">
                    Redis-backed WebSockets eliminate race conditions.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-foreground-muted">
                    Climb the global ranks based on your squad's real-world points.
                  </p>
                </div>
              </div>
            </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-xs text-foreground-muted mb-6">
                  {isLogin
                    ? 'Sign in to access your live auction draft rooms'
                    : 'Create an account to start drafting and climb standings'}
                </p>
