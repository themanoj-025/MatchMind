...
export const Landing: React.FC = () => {
  ...
  const draftRooms = [
    ...
    {
      name: 'Serie A Tactical Auction',
      managers: '10/10',
      status: 'LIVE',
      time: 'Active Bid: Kvaratskhelia',
      league: 'Serie A',
    },
        ...
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => scrollToSection('hero')}>
            ...
            <span className="font-semibold tracking-tight text-lg">
              MatchMind <span className="text-accent">Drafts</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Button
              variant="ghost"
              className="px-4 py-1.5 text-xs cursor-pointer font-medium text-foreground-muted hover:text-white"
          ...
          <div className="flex w-max animate-marquee hover:[animation-play-state:paused] gap-12 text-[10px] font-mono tracking-wider uppercase text-foreground-muted">
            {doubleTickerItems.map((item, index) => (
              <span key={index} className="flex items-center gap-2">
                ...
                <span
                  className={
                    item.type === 'sold' ? 'text-white' : item.type === 'live' ? 'text-live-red' : 'text-card-yellow'
                  }
                >
                  {item.text}
                </span>
      ...
      <main className="relative z-10 pt-28">
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-[10px] font-mono font-bold tracking-widest text-live-red">
                LIVE • DRAFT ARENA • V2.0
              </span>
            </motion.div>
            ...
            >
              <span className="text-gradient">Real-Time Auctions</span>
              <br />
            ...
            <motion.p
              variants={itemVariants}
              className="text-sm md:text-base text-foreground-muted max-w-2xl mx-auto mb-10 leading-relaxed"
            >
              MatchMind Drafts brings high-concurrency auction bidding, real-time draft updates, and AI-powered roster
              suggestions together in a premium sports-broadcast interface.
            </motion.p>
            ...
            >
              <div>
                ...
                <span className="text-xs text-foreground-muted block mt-1 uppercase font-semibold tracking-wider">
                  Players in Pool
                </span>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-8 gap-4">
              <div>
                <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full border border-live-red/20 bg-live-red/10 mb-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-live-red animate-pulse" />
                  <span className="text-[10px] font-mono font-bold tracking-wider text-live-red uppercase">
                    Live Arenas
                  </span>
                </div>
                <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-gradient">Available Draft Arenas</h2>
              </div>
              ...
              <div className="flex gap-1.5 bg-white/[0.02] border border-white/[0.04] p-1 rounded-lg self-stretch md:self-auto">
                <button
                  ...
                  className={`flex-1 md:flex-none px-3.5 py-1.5 text-xs font-semibold rounded-md transition-all cursor-pointer ${
                    activeTab === 'all' ? 'bg-white/[0.06] text-white' : 'text-foreground-muted hover:text-white'
                  }`}
                >
                  All
                </button>
                <button
                  ...
                  className={`flex-1 md:flex-none px-3.5 py-1.5 text-xs font-semibold rounded-md transition-all cursor-pointer ${
                    activeTab === 'live' ? 'bg-white/[0.06] text-white' : 'text-foreground-muted hover:text-white'
                  }`}
                >
                  Live
                </button>
                <button
                  ...
                  className={`flex-1 md:flex-none px-3.5 py-1.5 text-xs font-semibold rounded-md transition-all cursor-pointer ${
                    activeTab === 'upcoming' ? 'bg-white/[0.06] text-white' : 'text-foreground-muted hover:text-white'
                  }`}
                >
                  Upcoming
                </button>
            ...
            <div className="border border-white/[0.04] bg-[#0c0d13]/30 backdrop-blur-md rounded-xl overflow-hidden divide-y divide-white/[0.04]">
              {filteredRooms.map((room, index) => (
                <div
                  key={index}
                  className="flex flex-col md:flex-row items-start md:items-center justify-between p-4 gap-4 hover:bg-white/[0.01] transition-all"
                >
                  <div className="flex items-center gap-3">
                    {/* Badge */}
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`px-2 py-0.5 rounded text-[9px] font-bold tracking-wider ${
                          room.status === 'LIVE'
                            ? 'bg-live-red/10 text-live-red border border-live-red/20'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-pitch-green/20 bg-pitch-green/10 mb-4">
                ...
                <span className="text-[10px] font-mono font-bold tracking-wider text-pitch-green uppercase">
                  Pitch Showcase
                </span>
              </div>
              ...
              <p className="text-sm text-foreground-muted leading-relaxed mb-6">
                Arrange your auction-acquired gaffer squad directly on our pitch graphic. Toggle between dynamic tactics
                formations (4-3-3, 3-5-2) and watch your squad rating dynamically adjust based on live player
                statistics.
              </p>
              ...
              {squadPlayers.map((player, index) => (
                ...
                >
                  ...
                  <div className="w-8 h-8 rounded-full bg-[#12141c] border border-white/20 flex items-center justify-center shadow-lg relative group cursor-pointer hover:border-accent">
                    ...
                    <span
                      className={`absolute -bottom-1 -right-2 text-[8px] font-bold px-1 py-0.2 rounded ${
                        parseFloat(player.rating) >= 8.5
                          ? 'bg-pitch-green text-black'
                          : parseFloat(player.rating) >= 7.5
                            ? 'bg-gold text-black'
        ...
        <section id="leaderboards" className="container mx-auto px-6 py-20 border-t border-white/[0.02]">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xs text-foreground-muted mb-8 max-w-xl">
              Track global gaffer rankings computed in real time after every completed draft. Climb the ranks to unlock
              exclusive badges.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {playerPool.map((player, idx) => (
                <Card
                  key={idx}
                  className="p-5 border border-white/[0.04] bg-[#0c0d13]/30 backdrop-blur-md flex flex-col justify-between group hover:border-accent/40 transition-all duration-300"
                >
                    ...
                    <span
                      className={`px-2 py-0.5 rounded text-[8px] font-mono font-bold tracking-wider ${
                        player.tier === 'Icon'
                          ...
                          : player.tier === 'Premium'
                            ? 'bg-live-red/15 text-live-red border border-live-red/20'
                  ...
                  <div className="flex justify-between items-end border-t border-white/[0.04] pt-4 mt-2">
                    ...
                    <div className="text-right">
                      <span className="text-[9px] text-foreground-muted block uppercase tracking-wider font-semibold">
                        Base Val
                      </span>
        ...
        <section id="rules" className="container mx-auto px-6 py-20 border-t border-white/[0.02] mb-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xs text-foreground-muted mb-8 max-w-xl">
              Familiarize yourself with the MatchMind Drafts auction arena mechanics, bidding intervals, and
              multipliers.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6 border border-white/[0.04] bg-[#0c0d13]/30 backdrop-blur-md">
                ...
                <p className="text-xs text-foreground-muted leading-relaxed">
                  ...
                  **£100.0M** to bid on a full squad roster (11 players). All slots must be filled within the budget
                  rules.
                </p>
              </Card>
              ...
              <Card className="p-6 border border-white/[0.04] bg-[#0c0d13]/30 backdrop-blur-md">
                ...
                <p className="text-xs text-foreground-muted leading-relaxed">
                  ...
                  bidding, any bid submitted within the final **15 seconds** of a timer resets the clock back to 15
                  seconds.
                </p>
              </Card>
              ...
              <Card className="p-6 border border-white/[0.04] bg-[#0c0d13]/30 backdrop-blur-md">
                ...
                <p className="text-xs text-foreground-muted leading-relaxed">
                  ...
                  **2.0x points** and the Vice-Captain earns **1.5x points** based on real matchday stats.
                </p>
              </Card>
              ...
              <Card className="p-6 border border-white/[0.04] bg-[#0c0d13]/30 backdrop-blur-md">
                ...
                <p className="text-xs text-foreground-muted leading-relaxed">
                  ...
                  detailing roster gaps, budget scaling safety, and recommended maximum bid evaluations.
                </p>
              </Card>
            </div>
          </div>
